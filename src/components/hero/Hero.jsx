		...
		<div className=' w-screen h-[400px] relative flex flex-col gap-2'>
			<AnimatePresence initial={false}>
				<motion.div
					...
					className='w-64 h-32 rounded-xl bg-green-300'></motion.div>
				<motion.div
					initial={{ x: 500 }}
					...
					className='w-64 h-32 rounded-xl bg-purple-300'></motion.div>
				<motion.div
					initial={{ x: 500 }}
					...
					className='w-64 h-32 rounded-xl bg-red-300'></motion.div>
